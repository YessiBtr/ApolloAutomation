...
Mobile.comment('Search by invalid product')
...
'Verify element Cari nama produk button has attribute content-desc to action'
...
Mobile.setText(findTestObject('Sidebar Menu/Produk/Stock View/Cari nama produk - btn'), 'Lontong sayur', GlobalVariable.G_ShortTimeOut)

not_run: Mobile.hideKeyboard()

'Get top up message(yang di tampung dalam sebuah tampungan)'
ErMsg = Mobile.getText(findTestObject('Sidebar Menu/Produk/Stock View/Belum ada produk - Error Message'), GlobalVariable.G_ShortTimeOut)

'Verify top up message '
Mobile.verifyEqual(ErMsg, 'Belum ada produk')
