...
Mobile.comment(' Click Tambah Barang button')
...
'Wait until verify Onboarding Product screen is present'
...
'Verify to check if element Tambah Barang button has attribute content-desc to do action '
