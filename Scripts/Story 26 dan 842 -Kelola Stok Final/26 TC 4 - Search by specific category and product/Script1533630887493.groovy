...
Mobile.comment(' Search by specific category and product')
...
'Scroll Text to find MAKANAN category'
Mobile.scrollToText('Makanan', FailureHandling.CONTINUE_ON_FAILURE)

'Wait until List Kategori - Elemen 0 present'
Mobile.waitForElementPresent(findTestObject('Sidebar Menu/Produk/Stock View/List Kategori - Elemen Makanan'), GlobalVariable.G_ShortTimeOut)

'Click List Kategori - Elemen 0'
Mobile.tap(findTestObject('Sidebar Menu/Produk/Stock View/List Kategori - Elemen Makanan'), GlobalVariable.G_ShortTimeOut)

'Wait until Cari Produk button present'
...
'Verify Element Cari Produk - Parent has Attribute  content-desc  to do action'
...
Mobile.setText(findTestObject('Sidebar Menu/Produk/Stock View/Cari nama produk - btn'), 'Ayam', GlobalVariable.G_Timeout)
