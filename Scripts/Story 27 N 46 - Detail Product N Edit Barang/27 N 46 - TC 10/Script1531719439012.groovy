...
Mobile.comment('Edit Harga Beli field blank')
...
ErMsg1 = Mobile.getText(findTestObject('Sidebar Menu/Produk/Tambah Barang/Error Message - Harga Beli filed'), GlobalVariable.G_ShortTimeOut)

Mobile.verifyEqual(ErMsg1, 'Mohon diisi')

Mobile.comment('Isi Harga Beli')
...
Mobile.setText(findTestObject('Sidebar Menu/Produk/Tambah Barang/HargaBeli - TextInput'), '75000', GlobalVariable.G_ShortTimeOut)

Mobile.hideKeyboard()

Mobile.verifyElementText(findTestObject('Sidebar Menu/Produk/Tambah Barang/HargaBeli - TextInput'), '75.000')
