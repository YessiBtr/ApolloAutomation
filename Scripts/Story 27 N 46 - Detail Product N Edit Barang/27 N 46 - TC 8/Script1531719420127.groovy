...
Mobile.comment('Edit SKU Produk by input manual barcode')

Mobile.comment('Set Nama Barang')
...
Mobile.setText(findTestObject('Sidebar Menu/Produk/Tambah Barang/Nama Barang - Text Box'), 'MIMINO Bottle update', 5)

Mobile.hideKeyboard()

Mobile.verifyElementAttributeValue(findTestObject('Sidebar Menu/Produk/Tambah Barang/Nama Barang - Text Box'), 'text', 'MIMINO Bottle update', 
    5)
