...
Mobile.waitForElementPresent(findTestObject('Sidebar Menu/Produk/Tambah Barang/Pilih Kategori - SelectButton'), 
    5)

'Klik Pilih Kategori'
Mobile.tap(findTestObject('Sidebar Menu/Produk/Tambah Barang/Pilih Kategori - SelectButton'), 5, FailureHandling.STOP_ON_FAILURE)
