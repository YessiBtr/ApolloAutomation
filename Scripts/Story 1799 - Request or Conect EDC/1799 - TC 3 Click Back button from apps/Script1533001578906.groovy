...
Mobile.waitForElementPresent(findTestObject('Sidebar Menu/Dashboard/Back_btn_device'), GlobalVariable.G_ShortTimeOut)

Mobile.verifyElementAttributeValue(findTestObject('Sidebar Menu/Dashboard/Back_btn_device'), 'content-desc', '', GlobalVariable.G_ShortTimeOut)

Mobile.tap(findTestObject('Sidebar Menu/Dashboard/Back_btn_device'), GlobalVariable.G_ShortTimeOut)
