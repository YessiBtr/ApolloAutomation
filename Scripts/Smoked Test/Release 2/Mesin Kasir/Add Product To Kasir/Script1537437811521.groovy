...
action.longPress(300, 1124).moveTo(300, 346).release().perform()

Mobile.waitForElementPresent(findTestObject('Object Repository/Sidebar Menu/Kasir/Kasir/Estimasi Detail Pesanan/Inpt_jmlh_product_bytext'), 
    GlobalVariable.G_ShortTimeOut, FailureHandling.CONTINUE_ON_FAILURE)

Mobile.setText(findTestObject('Object Repository/Sidebar Menu/Kasir/Kasir/Estimasi Detail Pesanan/Inpt_jmlh_product_bytext'), 
    '1', GlobalVariable.G_ShortTimeOut)

Mobile.verifyElementText(findTestObject('Sidebar Menu/Kasir/Kasir/Estimasi Detail Pesanan/Inpt_jmlh_product_bytext'), '11')
