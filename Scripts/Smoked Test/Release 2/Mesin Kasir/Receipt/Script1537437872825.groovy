...
Mobile.waitForElementPresent(findTestObject('Sidebar Menu/Kasir/Kasir/Pembayaran/Pembayaran - Tunai'), GlobalVariable.G_ShortTimeOut)

Mobile.verifyElementAttributeValue(findTestObject('Sidebar Menu/Kasir/Kasir/Pembayaran/Pembayaran - Tunai'), 'content-desc', 
    'payment-method-Tunai', GlobalVariable.G_ShortTimeOut)

Mobile.tap(findTestObject('Sidebar Menu/Kasir/Kasir/Pembayaran/Pembayaran - Tunai'), GlobalVariable.G_ShortTimeOut)

Mobile.waitForElementPresent(findTestObject('Sidebar Menu/Kasir/Kasir/Pembayaran/Pembayaran - Bayarbtn'), GlobalVariable.G_ShortTimeOut)

Mobile.verifyElementAttributeValue(findTestObject('Sidebar Menu/Kasir/Kasir/Pembayaran/Pembayaran - Bayarbtn'), 'content-desc', 
    'bayarBtn', GlobalVariable.G_ShortTimeOut)

Mobile.tap(findTestObject('Sidebar Menu/Kasir/Kasir/Pembayaran/Pembayaran - Bayarbtn'), GlobalVariable.G_ShortTimeOut)

Mobile.verifyElementVisible(findTestObject('Object Repository/Sidebar Menu/Kasir/Kasir/Receipt/PaymentReceipt_Screen'), 
    GlobalVariable.G_ShortTimeOut)

Mobile.verifyElementVisible(findTestObject('Object Repository/Sidebar Menu/Kasir/Kasir/Receipt/Receipt - Cetak'), GlobalVariable.G_ShortTimeOut)

Mobile.verifyElementVisible(findTestObject('Object Repository/Sidebar Menu/Kasir/Kasir/Receipt/Receipt - Selesai'), GlobalVariable.G_ShortTimeOut)

Mobile.verifyElementVisible(findTestObject('Object Repository/Sidebar Menu/Kasir/Kasir/Receipt/Receipt- Bagikan'), GlobalVariable.G_ShortTimeOut)

Mobile.waitForElementPresent(findTestObject('Sidebar Menu/Kasir/Kasir/Receipt/Receipt - Selesai'), GlobalVariable.G_ShortTimeOut)

Mobile.verifyElementAttributeValue(findTestObject('Sidebar Menu/Kasir/Kasir/Receipt/Receipt - Selesai'), 'content-desc', 
    'selesai_abutton', GlobalVariable.G_ShortTimeOut)

Mobile.tap(findTestObject('Sidebar Menu/Kasir/Kasir/Receipt/Receipt - Selesai'), GlobalVariable.G_ShortTimeOut)
