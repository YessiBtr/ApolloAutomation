...
Mobile.waitForElementPresent(findTestObject('Object Repository/Sidebar Menu/Kasir/Riwayat Transaksi/Riwayat Transaksi'), GlobalVariable.G_ShortTimeOut, FailureHandling.CONTINUE_ON_FAILURE)

Mobile.verifyElementAttributeValue(findTestObject('Object Repository/Sidebar Menu/Kasir/Riwayat Transaksi/Riwayat Transaksi'), 'content-desc', 'riwayatTransaksiMenuItem', GlobalVariable.G_ShortTimeOut)

Mobile.tap(findTestObject('Object Repository/Sidebar Menu/Kasir/Riwayat Transaksi/Riwayat Transaksi'), GlobalVariable.G_ShortTimeOut)

if (Mobile.verifyElementVisible(findTestObject('Object Repository/Sidebar Menu/Kasir/Riwayat Transaksi/Rincian/List Rincian Transaksi 1'),
	GlobalVariable.G_ShortTimeOut, FailureHandling.CONTINUE_ON_FAILURE) == true) {
	
	Mobile.tap(findTestObject('Object Repository/Sidebar Menu/Kasir/Riwayat Transaksi/Rincian/List Rincian Transaksi 1'), GlobalVariable)

	println('Object Ditemukan')
	
	Mobile.verifyElementVisible(findTestObject('Object Repository/Sidebar Menu/Kasir/Riwayat Transaksi/Rincian/DetailRincianScreen'), GlobalVariable.G_ShortTimeOut)
	
	Mobile.verifyElementVisible(findTestObject('Sidebar Menu/Kasir/Riwayat Transaksi/Rincian/RiwayatTransaksiListScreen'), GlobalVariable.G_ShortTimeOut)
	
	Mobile.tap(findTestObject('Object Repository/Sidebar Menu/Kasir/Riwayat Transaksi/Rincian/Retur Button'), GlobalVariable.G_ShortTimeOut)
	
	Mobile.tap(findTestObject('Object Repository/Sidebar Menu/Kasir/Riwayat Transaksi/Rincian/Lanjut TopUp'), GlobalVariable.G_ShortTimeOut)
	
	Mobile.delay(GlobalVariable.G_ShortTimeOut)
	
	Mobile.verifyElementNotVisible(findTestObject('Object Repository/Sidebar Menu/Kasir/Riwayat Transaksi/Rincian/Retur Button'), GlobalVariable.G_ShortTimeOut)
...
{
	println('Object Tidak Ditemukan')
}
