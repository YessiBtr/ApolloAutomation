...
Mobile.waitForElementPresent(findTestObject('Sidebar Menu/Kasir/Kasir/Pembayaran/Jumlah Lainnya...'), GlobalVariable.G_ShortTimeOut)

Mobile.verifyElementAttributeValue(findTestObject('Sidebar Menu/Kasir/Kasir/Pembayaran/Jumlah Lainnya...'), 'content-desc', 
    '', GlobalVariable.G_ShortTimeOut)

Mobile.setText(findTestObject('Sidebar Menu/Kasir/Kasir/Pembayaran/Jumlah Lainnya...'), '500000', GlobalVariable.G_ShortTimeOut)

Mobile.hideKeyboard()

Mobile.verifyElementText(findTestObject('Sidebar Menu/Kasir/Kasir/Pembayaran/Jumlah Lainnya...'), '500.000')
