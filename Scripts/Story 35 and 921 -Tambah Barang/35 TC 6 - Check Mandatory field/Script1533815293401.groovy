...
Mobile.comment('Check Mandatory field')
...
Mobile.waitForElementPresent(findTestObject('Sidebar Menu/Produk/Tambah Barang/Simpan Button'), 5)
...
ErMsg = Mobile.getText(findTestObject('Sidebar Menu/Produk/Tambah Barang/Error Message - Nama Barang field'), 5)

Mobile.verifyEqual(ErMsg, 'Nama Barang is required')

Mobile.scrollToText('Stok Rendah', FailureHandling.CONTINUE_ON_FAILURE)

Mobile.delay(5, FailureHandling.STOP_ON_FAILURE)

ErMsg1 = Mobile.getText(findTestObject('Sidebar Menu/Produk/Tambah Barang/Error Message - Kategori field'), 5)

Mobile.verifyEqual(ErMsg1, 'Kategori is required')

ErMsg1 = Mobile.getText(findTestObject('Sidebar Menu/Produk/Tambah Barang/Error Message - Harga Beli filed'), 5)
