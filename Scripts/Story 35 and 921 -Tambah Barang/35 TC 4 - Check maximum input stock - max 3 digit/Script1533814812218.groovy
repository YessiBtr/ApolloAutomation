...
Mobile.comment('Check maximum input stock - max 3 digit')
...
Mobile.setText(findTestObject('Sidebar Menu/Produk/Tambah Barang/Jumlah Stock - by typing'), '23434567', 3)

Mobile.hideKeyboard()

Mobile.verifyElementAttributeValue(findTestObject('Sidebar Menu/Produk/Tambah Barang/Jumlah Stock - by typing'), 'text', 
    '234', GlobalVariable.G_ShortTimeOut)
