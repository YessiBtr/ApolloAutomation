...
Mobile.comment('Tambah Produk with input manual barcode')
...
Mobile.setText(findTestObject('Sidebar Menu/Produk/Tambah Barang/Nama Barang - Text Box'), 'MIMINO Bottle', 5)

Mobile.hideKeyboard()

Mobile.verifyElementAttributeValue(findTestObject('Sidebar Menu/Produk/Tambah Barang/Nama Barang - Text Box'), 'text', 'MIMINO Bottle', 
    5)
