...
Mobile.comment('User update stock when specifies stock = -(minus)')
...
Mobile.setText(findTestObject('Sidebar Menu/Produk/Tambah Barang/Jumlah Stock - by typing'), '-23', 3)

Mobile.hideKeyboard()

Mobile.verifyElementAttributeValue(findTestObject('Sidebar Menu/Produk/Tambah Barang/Jumlah Stock - by typing'), 'text', 
    '23', GlobalVariable.G_ShortTimeOut)

Mobile.clearText(findTestObject('Sidebar Menu/Produk/Tambah Barang/Jumlah Stock - by typing'), 2)

Mobile.setText(findTestObject('Sidebar Menu/Produk/Tambah Barang/Jumlah Stock - by typing'), '8.2', 3)

Mobile.hideKeyboard()

Mobile.verifyElementAttributeValue(findTestObject('Sidebar Menu/Produk/Tambah Barang/Jumlah Stock - by typing'), 'text', 
    '82', GlobalVariable.G_ShortTimeOut)

Mobile.comment('move to TC 4')
