...
Mobile.comment('Input valid data in Harga Jual')
...
Mobile.setText(findTestObject('Sidebar Menu/Produk/Tambah Barang/Harga Jual - TextBox'), '65000', GlobalVariable.G_ShortTimeOut)

Mobile.hideKeyboard()

Mobile.verifyElementText(findTestObject('Sidebar Menu/Produk/Tambah Barang/Harga Jual - TextBox'), '65.000')
