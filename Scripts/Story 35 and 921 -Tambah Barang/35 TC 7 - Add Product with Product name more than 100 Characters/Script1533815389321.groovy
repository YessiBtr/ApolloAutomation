...
Mobile.comment('Add Product with Product name more than 100 Characters')
...
not_run: TouchAction action = new TouchAction(driver)

not_run: action.longPress(242, 360).moveTo(242, 743).release().perform()

///*Call AppiumDriver to swipe*
// */
//AppiumDriver<?> driver = MobileDriverFactory.getDriver()
//
//TouchAction action = new TouchAction(driver)
//
//action.longPress(200, 160).moveTo(200, 1016).release().perform()
Mobile.waitForElementPresent(findTestObject('Sidebar Menu/Produk/Tambah Barang/Nama Barang - Text Box'), 5, FailureHandling.STOP_ON_FAILURE)
 ...
 * Call bigname keywords
 * @return randomstring
 * */
String NamaBarang = CustomKeywords.'newpackage.allkeyword.randombigname'()

Mobile.setText(findTestObject('Sidebar Menu/Produk/Tambah Barang/Nama Barang - Text Box'), NamaBarang, GlobalVariable.G_ShortTimeOut)

Mobile.hideKeyboard()

Mobile.verifyEqual(NamaBarang, NamaBarang)
