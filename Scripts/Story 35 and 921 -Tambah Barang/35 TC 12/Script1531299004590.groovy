...
Mobile.comment('Input invalid format Harga Beli = 2k')
...
Mobile.setText(findTestObject('Sidebar Menu/Produk/Tambah Barang/HargaBeli - TextInput'), '2k', GlobalVariable.G_ShortTimeOut)

Mobile.hideKeyboard()

Mobile.verifyElementText(findTestObject('Sidebar Menu/Produk/Tambah Barang/HargaBeli - TextInput'), '2')
