...
Mobile.tap(findTestObject('Sidebar Menu/Pengaturan Toko/Printer Menu/Printer'), GlobalVariable.G_ShortTimeOut)

Mobile.verifyElementVisible(findTestObject('Sidebar Menu/Pengaturan Toko/Printer Menu/DialogAkanHadir'), GlobalVariable.G_ShortTimeOut)

ErMsg = Mobile.getText(findTestObject('Sidebar Menu/Pengaturan Toko/Printer Menu/Message-Akan Hadir'), GlobalVariable.G_ShortTimeOut)

Mobile.verifyEqual(ErMsg, 'Akan Hadir')

ErMsg = Mobile.getText(findTestObject('Sidebar Menu/Pengaturan Toko/Printer Menu/Cetak Struk dengan mesin pencetak yang terhubung lewat Bluetooth'), 
    GlobalVariable.G_ShortTimeOut)

Mobile.verifyEqual(ErMsg, 'Cetak Struk dengan mesin pencetak yang terhubung lewat Bluetooth')

Mobile.waitForElementPresent(findTestObject('Object Repository/Sidebar Menu/Pengaturan Toko/Printer Menu/OKButton'), GlobalVariable.G_ShortTimeOut)

Mobile.verifyElementAttributeValue(findTestObject('Sidebar Menu/Pengaturan Toko/Printer Menu/OKButton'), 'content-desc', 
    'ADialogStatic_buttonLabel_informationDialog', GlobalVariable.G_ShortTimeOut)

Mobile.tap(findTestObject('Sidebar Menu/Pengaturan Toko/Printer Menu/OKButton'), GlobalVariable.G_ShortTimeOut)
