...
Mobile.waitForElementPresent(findTestObject('Sidebar Menu/Pengeluaran/Tambah Pengeluaran/BayarViaApps/OK_button'), GlobalVariable.G_ShortTimeOut)

Mobile.verifyElementAttributeValue(findTestObject('Sidebar Menu/Pengeluaran/Tambah Pengeluaran/BayarViaApps/OK_button'), 
    'content-desc', 'ADialogStatic_buttonLabel_informationDialog', GlobalVariable.G_ShortTimeOut)

Mobile.tap(findTestObject('Sidebar Menu/Pengeluaran/Tambah Pengeluaran/BayarViaApps/OK_button'), GlobalVariable.G_ShortTimeOut)
...
Mobile.verifyElementVisible(findTestObject('Sidebar Menu/Pengeluaran/Tambah Pengeluaran/Tambah_expense_button'), GlobalVariable.G_ShortTimeOut)
