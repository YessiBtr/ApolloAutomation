...
ErMsg = Mobile.getText(findTestObject('Sidebar Menu/Kasir/Kasir/Ringkasan Pesanan/Biaya Tambahan/ErMsg-NBHarus diisi'), 
    GlobalVariable.G_ShortTimeOut)

Mobile.verifyEqual(ErMsg, 'Harus diisi')

ErMsg = Mobile.getText(findTestObject('Sidebar Menu/Kasir/Kasir/Ringkasan Pesanan/Biaya Tambahan/ErMsg - BiayaHarus diisi'), 
    GlobalVariable.G_ShortTimeOut)
