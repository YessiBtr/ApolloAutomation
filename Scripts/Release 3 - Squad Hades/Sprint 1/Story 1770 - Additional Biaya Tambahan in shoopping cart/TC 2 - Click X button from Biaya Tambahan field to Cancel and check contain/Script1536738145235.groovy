...
Mobile.waitForElementPresent(findTestObject('Sidebar Menu/Kasir/Kasir/Ringkasan Pesanan/Biaya Tambahan/cross_button - BiayaKirim'), 
    GlobalVariable.G_ShortTimeOut)

Mobile.verifyElementAttributeValue(findTestObject('Sidebar Menu/Kasir/Kasir/Ringkasan Pesanan/Biaya Tambahan/cross_button - BiayaKirim'), 
    'content-desc', 'asubtotal_abutton_additional_cost_clear', GlobalVariable.G_ShortTimeOut)

Mobile.tap(findTestObject('Sidebar Menu/Kasir/Kasir/Ringkasan Pesanan/Biaya Tambahan/cross_button - BiayaKirim'), 
    GlobalVariable.G_ShortTimeOut)

Mobile.waitForElementPresent(findTestObject('Sidebar Menu/Kasir/Kasir/Ringkasan Pesanan/Biaya Tambahan/Tambah_Biaya'), 
    GlobalVariable.G_ShortTimeOut)

Mobile.verifyElementVisible(findTestObject('Sidebar Menu/Kasir/Kasir/Ringkasan Pesanan/Biaya Tambahan/Tambah_Biaya'), 
    GlobalVariable.G_ShortTimeOut)
