...
Mobile.comment('Edit Biaya Tambahan')
...
Mobile.waitForElementPresent(findTestObject('Sidebar Menu/Kasir/Kasir/Ringkasan Pesanan/Biaya Tambahan/TambahBiaya - JudulList1'), 
    GlobalVariable.G_ShortTimeOut)

Mobile.verifyElementAttributeValue(findTestObject('Sidebar Menu/Kasir/Kasir/Ringkasan Pesanan/Biaya Tambahan/TambahBiaya - JudulList1'), 
    'content-desc', 'additionalCost_text_costType_0', GlobalVariable.G_ShortTimeOut)

Mobile.tap(findTestObject('Sidebar Menu/Kasir/Kasir/Ringkasan Pesanan/Biaya Tambahan/TambahBiaya - JudulList1'), GlobalVariable.G_ShortTimeOut)
...
Mobile.clearText(findTestObject('Sidebar Menu/Kasir/Kasir/Ringkasan Pesanan/Biaya Tambahan/TambahBiaya - BiayaEditTxt'), 
    GlobalVariable.G_ShortTimeOut)

Mobile.setText(findTestObject('Sidebar Menu/Kasir/Kasir/Ringkasan Pesanan/Biaya Tambahan/TambahBiaya - BiayaEditTxt'), 
    '50000', GlobalVariable.G_ShortTimeOut)
