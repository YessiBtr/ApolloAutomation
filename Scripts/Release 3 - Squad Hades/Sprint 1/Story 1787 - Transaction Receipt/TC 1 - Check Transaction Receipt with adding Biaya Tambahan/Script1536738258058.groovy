...
Mobile.setText(findTestObject('Sidebar Menu/Kasir/Kasir/Ringkasan Pesanan/Diskon Tambahan/DiskonTbhan_edittext'), 
    '2000', GlobalVariable.G_ShortTimeOut)

Mobile.hideKeyboard()

Mobile.waitForElementPresent(findTestObject('Sidebar Menu/Kasir/Kasir/Ringkasan Pesanan/Diskon Tambahan/Terapkanbtn'), 
    GlobalVariable.G_ShortTimeOut)
