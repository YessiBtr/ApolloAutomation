...
Mobile.verifyElementVisible(findTestObject('Sidebar Menu/Pengaturan Toko/EDC Menu/ErMsg - Mesin EDC belum terhubung'), GlobalVariable.G_ShortTimeOut)

Mobile.verifyElementVisible(findTestObject('Sidebar Menu/Pengaturan Toko/EDC Menu/ErMsg -Metode pembayaran kredit'), GlobalVariable.G_ShortTimeOut)
