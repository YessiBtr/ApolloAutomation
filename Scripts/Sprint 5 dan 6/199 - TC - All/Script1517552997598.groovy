...
Mobile.comment('Start Story 199')
...
Mobile.comment('Link to FB')

Mobile.swipe(390, 486, 450, 486)

Mobile.waitForElementPresent(findTestObject('Sidebar Menu/Ringkasan/Penjualan/Batal - after swipe fb'), 5)

Mobile.tap(findTestObject('Sidebar Menu/Ringkasan/Penjualan/Batal - after swipe fb'), 5)

Mobile.delay(3, FailureHandling.STOP_ON_FAILURE)

Mobile.swipe(390, 486, 450, 486)

Mobile.waitForElementPresent(findTestObject('Sidebar Menu/Ringkasan/Penjualan/Lanjutkan - after Swipe Fb'), 5)

Mobile.tap(findTestObject('Sidebar Menu/Ringkasan/Penjualan/Lanjutkan - after Swipe Fb'), 5)

Mobile.verifyElementExist(findTestObject('Sidebar Menu/Ringkasan/Penjualan/Lanjutkan - after Swipe Fb'), 5)

Mobile.comment('Link to IG')
...
Mobile.setText(findTestObject('Sidebar Menu/Ringkasan/Penjualan/Nama pengguna IG'), 'ysyrelita', 5)

Mobile.verifyElementText(findTestObject('Sidebar Menu/Ringkasan/Penjualan/Nama pengguna IG'), 'ysyrelita')

Mobile.getText(findTestObject('Sidebar Menu/Ringkasan/Penjualan/Nama pengguna IG'), 5)

Mobile.setText(findTestObject('Sidebar Menu/Ringkasan/Penjualan/Kata Sandi IG'), 'mamakusayang', 5)

Mobile.getText(findTestObject('Sidebar Menu/Ringkasan/Penjualan/Kata Sandi IG'), 6)

Mobile.tap(findTestObject('Sidebar Menu/Ringkasan/Penjualan/Masuk - IG'), 5)
